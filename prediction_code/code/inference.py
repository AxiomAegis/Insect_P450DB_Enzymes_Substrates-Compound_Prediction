...
pretrained_TN = "../saved_model/p450_ESP_1gpus_bs72_1e-05_layers6.pkl"
xgb_path = "../saved_model/p450_ESP_xgb"
xgb_ESM1b_ChemBERTa = f"{xgb_path}/ESM1b_ChemBERTa.pkl"
xgb_ESM1b_ChemBERTa_cls = f"{xgb_path}/ESM1b_ChemBERTa_cls.pkl"
xgb_cls = f"{xgb_path}/cls.pkl"
...
def inference(df):
    ...
    #### Final predictions:
    # 【默认】best_i, best_j, best_k = 0.45, 0.50, 0.05
    # 【BAHD正和T1正负】ESM1b+ChemBERTa2+cls: 0.46, ESM1b+ChemBERTa2: 0.52, cls-token: 0.02
    # 【BAHD正负和T1负】ESM1b+ChemBERTa2+cls: 0.37, ESM1b+ChemBERTa2: 0.6, cls-token: 0.030000000000000027
    # 【BAHD正负，t1正负测试】ESM1b+ChemBERTa2+cls: 0.01, ESM1b+ChemBERTa2: 0.67, cls-token: 0.31999999999999995
    # 【BAHD正负，t1负测试】ESM1b+ChemBERTa2+cls: 0.07, ESM1b+ChemBERTa2: 0.84, cls-token: 0.08999999999999997
    best_i, best_j, best_k = 0.07, 0.84, 0.09
