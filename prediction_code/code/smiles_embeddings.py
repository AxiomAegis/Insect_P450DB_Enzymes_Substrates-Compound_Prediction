...
# SMILES_BERT = "../../code/preprocessing/DeepChem/ChemBERTa-77M-MTR"
...
MODELS_DIR = join("..", "pretrained_model", "ChemBERTa")
smiles_bert = AutoModelForMaskedLM.from_pretrained(join(MODELS_DIR, "save_miles_bert/"))
smiles_tokenizer = AutoTokenizer.from_pretrained(join(MODELS_DIR, "66b895cab8adebea0cb59a8effa66b2020f204ca"))
# smiles_bert = AutoModelForMaskedLM.from_pretrained(MODELS_DIR)
# smiles_tokenizer = AutoTokenizer.from_pretrained(MODELS_DIR)
