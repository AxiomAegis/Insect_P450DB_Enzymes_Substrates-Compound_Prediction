...
BASE_DIR = join(".")
MODELS_DIR = join("..", "pretrained_model", "ESM1b", "esm1b_t33_650M_UR50S.pt")
...
def calculate_protein_embeddings(all_sequences, prot_emb_no = 1000):
    ...
    # model, alphabet = pretrained.load_model_and_alphabet("../../code/preprocessing/esm1b_t33_650M_UR50S")
    model, alphabet = esm.pretrained.load_model_and_alphabet_local(model_location = MODELS_DIR)
    model.eval()
